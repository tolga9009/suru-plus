...
```shell
$ sudo git clone https://github.com/suru-plus/suru-plus.git /usr/share/icons/Suru++
```
* Set the icon theme:
```shell
...
```shell
sudo svn export --force https://github.com/suru-plus/suru-plus/trunk/ /usr/share/icons/Suru++
```
...
* GPL3 © 2018 Suru++ [Minimal] by Andrea Bonanni and Suru++ Project. 
* GPL3 © 2018 Suru++ 20 by Suru++ Project.
